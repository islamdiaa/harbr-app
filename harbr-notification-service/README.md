# Harbr Notification Service

A TypeScript backend service that handles receiving webhooks from applications supported in [Harbr](https://www.harbr.app/github) and sends notifications to the respective user or device.

> Setting up an instance of your own notification service is **not** necessary to get webhook notifications in Harbr, simply use the hosted notification service available at [https://notify.harbr.app](https://notify.harbr.app). Setting up your own instance _will not_ send notifications to the officially published Harbr application.
>
> Setting up your own instance of the notification service is only necessary when building your own version of Harbr, which utilizes a different Firebase project.

## Usage

For documentation on setting up the webhooks, please look at Harbr's documentation [available here](https://notify.harbr.app).
...
ghcr.io/islamdiaa/harbr-notification-service:latest
```

## Development & Installation

Harbr's Notification Service requires:
