...
{% tabs %}
{% tab title="Name" %}
Select any name, for example "Harbr".
{% endtab %}
...
The username field should be an **exact match** to the profile that this module instance was added to within Harbr. Capitalization and punctuation _does_ matter.
{% endtab %}
...
Once setup, close Harbr and run the webhook test in Sonarr. You should receive a new notification letting you know that Harbr is ready to receive Sonarr notifications!
