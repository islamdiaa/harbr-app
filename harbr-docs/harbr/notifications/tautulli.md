...
In Tautulli's web GUI, head to Settings -> Notification Agents, hit the "Add a new notification agent" button and select "Harbr". Please follow each section below to setup the webhook:
...
Enter in the name of the profile which should be an **exact match** to the profile that this module instance was added to within Harbr. Capitalization and punctuation _does_ matter.
...
Once setup, close Harbr and run the webhook test in Tautulli. You should receive a new notification letting you know that Harbr is ready to receive Tautulli notifications!
