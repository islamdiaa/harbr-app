...
Harbr offers four different build channels, each of which supply signed and notarized copies of Harbr.

All releases for every build channel can be downloaded from the [build bucket](https://builds.harbr.app/), and all stable releases for all platforms are also available on [GitHub](https://github.com/islamdiaa/Harbr/releases).
