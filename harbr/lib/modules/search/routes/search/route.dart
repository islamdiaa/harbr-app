...
class _State extends State<SearchIndexerRoute> with HarbrScrollControllerMixin {
  ...
  Widget _appBar() {
    ...
    if (category != null && subcategory != null) {
      title = '$title > ${subcategory.name ?? 'harbr.Unknown'.tr()}';
    }
    return HarbrAppBar(
      title: title,
  ...
  Widget _body() {
    if (_firstSearched)
      return HarbrPagedListView<NewznabResultData>(
