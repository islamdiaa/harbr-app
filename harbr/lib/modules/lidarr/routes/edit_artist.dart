...
class _State extends State<ArtistEditRoute> with HarbrScrollControllerMixin {
  ...
  Future<void> _changePath() async {
    Tuple2<bool, String> _values =
        await HarbrDialogs().editText(context, 'Artist Path', prefill: _path!);
  ...
  Future<void> _save() async {
    ...
    await _api
      ...
      HarbrLogger().error('Failed to update artist', error, stack);
