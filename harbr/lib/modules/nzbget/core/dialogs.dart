...
class NZBGetDialogs {
  ...
  static Future<List<dynamic>> customSpeedLimit(BuildContext context) async {
    ...
    await HarbrDialog.dialog(
      ...
      content: [
        HarbrDialog.textContent(text: 'Please enter a speed limit in KB/s.'),
        Form(
          key: _formKey,
          child: HarbrDialog.textFormInput(
            controller: _textController,
    ...
    await HarbrDialog.dialog(
      ...
      content: [
        HarbrDialog.richText(
          children: [
            HarbrDialog.textSpanContent(text: 'Please enter how long in '),
            HarbrDialog.bolded(text: 'minutes'),
