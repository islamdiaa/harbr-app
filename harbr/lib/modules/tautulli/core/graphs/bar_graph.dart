          ...
          barRods: [
            BarChartRodData(
              ...
              borderRadius: const BorderRadius.only(
                topLeft: Radius.circular(HarbrUI.BORDER_RADIUS / 3),
                topRight: Radius.circular(HarbrUI.BORDER_RADIUS / 3),
              ),
              rodStackItems: List<BarChartRodStackItem>.generate(
                ...
                (sIndex) => BarChartRodStackItem(
                  ...
                  HarbrColours().byGraphLayer(sIndex),
                ),
              ),
            ),
          ],
  ...
  static BarTouchData barTouchData(
      ...
      BarTouchData(
        ...
        touchTooltipData: BarTouchTooltipData(
          ...
          tooltipRoundedRadius: HarbrUI.BORDER_RADIUS,
