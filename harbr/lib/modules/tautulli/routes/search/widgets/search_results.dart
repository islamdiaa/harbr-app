...
class _State extends State<TautulliSearchSearchResults> {
  ...
  List<Widget> _movies(List<TautulliSearchResult> movies) => [
        const HarbrHeader(text: 'movies'),
        if (movies.isEmpty) const HarbrMessage(text: 'No Results Found'),
  ...
  List<Widget> _series(List<TautulliSearchResult> series) => [
        const HarbrHeader(text: 'series'),
        if (series.isEmpty) const HarbrMessage(text: 'No Results Found'),
  ...
  List<Widget> _seasons(List<TautulliSearchResult> seasons) => [
        const HarbrHeader(text: 'seasons'),
        if (seasons.isEmpty) const HarbrMessage(text: 'No Results Found'),
  ...
  List<Widget> _episodes(List<TautulliSearchResult> episodes) => [
        const HarbrHeader(text: 'episodes'),
        if (episodes.isEmpty) const HarbrMessage(text: 'No Results Found'),
  ...
  List<Widget> _artists(List<TautulliSearchResult> artists) => [
        const HarbrHeader(text: 'artists'),
        if (artists.isEmpty) const HarbrMessage(text: 'No Results Found'),
  ...
  List<Widget> _albums(List<TautulliSearchResult> albums) => [
        const HarbrHeader(text: 'albums'),
        if (albums.isEmpty) const HarbrMessage(text: 'No Results Found'),
  ...
  List<Widget> _tracks(List<TautulliSearchResult> tracks) => [
        const HarbrHeader(text: 'tracks'),
        if (tracks.isEmpty) const HarbrMessage(text: 'No Results Found'),
  ...
  List<Widget> _collections(List<TautulliSearchResult> collections) => [
        const HarbrHeader(text: 'collections'),
        if (collections.isEmpty) const HarbrMessage(text: 'No Results Found'),
