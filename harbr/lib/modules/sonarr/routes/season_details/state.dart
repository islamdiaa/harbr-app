...
import 'package:harbr/system/cache/memory/memory_cache.dart';
...
class SonarrSeasonDetailsState extends ChangeNotifier {
  ...
  HarbrLoadingState _episodeSearchState = HarbrLoadingState.INACTIVE;
  HarbrLoadingState get episodeSearchState => _episodeSearchState;
  set episodeSearchState(HarbrLoadingState state) {
    _episodeSearchState = state;
    notifyListeners();
  }

  final _episodeHistoryCache = HarbrMemoryCache<Future<SonarrHistoryPage>>(
    maxEntries: 10,
