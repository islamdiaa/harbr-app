...
class SonarrState extends HarbrModuleState {
  SonarrState() {
    reset();
  }
  ...
  HarbrListViewOption _seriesViewType =
      SonarrDatabase.DEFAULT_VIEW_SERIES.read();
  HarbrListViewOption get seriesViewType => _seriesViewType;
  set seriesViewType(HarbrListViewOption seriesViewType) {
