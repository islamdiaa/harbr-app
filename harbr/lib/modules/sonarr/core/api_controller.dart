  ...
  Future<bool> backupDatabase({
    ...
    if (context.read<SonarrState>().enabled) {
      return await context.read<SonarrState>().api!.command.backup().then((_) {
        if (showSnackbar) {
          showHarbrSuccessSnackBar(
            title: 'sonarr.BackingUpDatabase'.tr(args: [HarbrUI.TEXT_ELLIPSIS]),
  ...
  Future<bool> automaticSeasonSearch({
    ...
    if (context.read<SonarrState>().enabled) {
      return await context
        ...
        if (showSnackbar)
          showHarbrSuccessSnackBar(
            title: 'sonarr.SearchingForSeason'.tr(args: [HarbrUI.TEXT_ELLIPSIS]),
  ...
  Future<bool> runRSSSync({
    ...
    if (context.read<SonarrState>().enabled) {
      return await context.read<SonarrState>().api!.command.rssSync().then((_) {
        if (showSnackbar)
          showHarbrSuccessSnackBar(
            title: 'sonarr.RunningRSSSync'.tr(args: [HarbrUI.TEXT_ELLIPSIS]),
  ...
  Future<bool> updateLibrary({
    ...
    if (context.read<SonarrState>().enabled) {
      return await context
        ...
        if (showSnackbar)
          showHarbrSuccessSnackBar(
            title: 'sonarr.UpdatingLibrary'.tr(args: [HarbrUI.TEXT_ELLIPSIS]),
  ...
  Future<bool> missingEpisodesSearch({
    ...
    if (context.read<SonarrState>().enabled) {
      return await context
        ...
        if (showSnackbar)
          showHarbrSuccessSnackBar(
            title: 'sonarr.Searching'.tr(args: [HarbrUI.TEXT_ELLIPSIS]),
