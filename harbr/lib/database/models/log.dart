...
@HiveType(typeId: 23, adapterName: 'HarbrLogAdapter')
class HarbrLog extends HiveObject {
  @HiveField(0)
  final int timestamp;
  @HiveField(1)
  ...
  factory HarbrLog.withMessage({
    required HarbrLogType type,
