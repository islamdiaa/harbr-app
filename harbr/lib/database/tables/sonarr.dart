...
import 'package:harbr/modules/sonarr/core/types/filter_releases.dart';
import 'package:harbr/modules/sonarr/core/types/filter_series.dart';
import 'package:harbr/modules/sonarr/core/types/monitor_status.dart';
import 'package:harbr/modules/sonarr/core/types/sorting_releases.dart';
import 'package:harbr/modules/sonarr/core/types/sorting_series.dart';
import 'package:harbr/types/list_view_option.dart';
import 'package:harbr/vendor.dart';

enum SonarrDatabase<T> with HarbrTableMixin<T> {
  ...
  DEFAULT_VIEW_SERIES<HarbrListViewOption>(HarbrListViewOption.BLOCK_VIEW),
  ...
  @override
  HarbrTable get table => HarbrTable.sonarr;
  ...
  void import(dynamic value) {
    ...
    switch (db) {
      ...
      case SonarrDatabase.DEFAULT_FILTERING_RELEASES:
        ...
        break;
      case SonarrDatabase.DEFAULT_VIEW_SERIES:
        result = HarbrListViewOption.fromKey(value.toString());
        break;
      default:
        result = value;
        break;
