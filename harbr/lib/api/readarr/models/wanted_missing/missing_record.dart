...
class ReadarrMissingRecord {
  ...
  factory ReadarrMissingRecord.fromJson(Map<String, dynamic> json) =>
      _$ReadarrMissingRecordFromJson(json);

  Map<String, dynamic> toJson() => _$ReadarrMissingRecordToJson(this);
}
