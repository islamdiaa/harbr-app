...
class HarbrTheme {
  ...
  ThemeData _midnightTheme() {
    return ThemeData(
      ...
      canvasColor: HarbrColours.primary,
      primaryColor: HarbrColours.secondary,
      highlightColor: HarbrColours.accent.withOpacity(HarbrUI.OPACITY_SPLASH / 2),
      cardColor: HarbrColours.secondary,
      hoverColor: HarbrColours.accent.withOpacity(HarbrUI.OPACITY_SPLASH / 2),
      splashColor: HarbrColours.accent.withOpacity(HarbrUI.OPACITY_SPLASH),
      dialogTheme: DialogThemeData(
        backgroundColor: HarbrColours.secondary,
      ),
      ...
      tooltipTheme: const TooltipThemeData(
        decoration: BoxDecoration(
          color: HarbrColours.secondary,
          borderRadius: BorderRadius.all(Radius.circular(HarbrUI.BORDER_RADIUS)),
        ),
        textStyle: TextStyle(
      ...
      tooltipTheme: TooltipThemeData(
        decoration: BoxDecoration(
          ...
          borderRadius: const BorderRadius.all(
            Radius.circular(HarbrUI.BORDER_RADIUS),
          ),
          border: useBorders ? Border.all(color: HarbrColours.white10) : null,
        ),
  ...
  SystemUiOverlayStyle get overlayStyle {
    return SystemUiOverlayStyle(
      systemNavigationBarColor: HarbrDatabase.THEME_AMOLED.read()
          ? Colors.black
          : HarbrColours.secondary,
      systemNavigationBarDividerColor: HarbrDatabase.THEME_AMOLED.read()
          ? Colors.black
          : HarbrColours.secondary,
