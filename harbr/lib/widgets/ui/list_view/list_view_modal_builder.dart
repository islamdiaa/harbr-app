...
class HarbrListViewModalBuilder extends StatelessWidget {
  final int itemCount;
  final Widget Function(BuildContext, int) itemBuilder;
  final HarbrBottomActionBar? actionBar;
  final HarbrAppBar? appBar;
  final double? appBarHeight;
  final double? itemExtent;

  const HarbrListViewModalBuilder({
    Key? key,
  ...
  EdgeInsets _padding(BuildContext context) {
    ...
    return EdgeInsets.fromLTRB(
      ...
      appBar != null
          ? HarbrUI.MARGIN_H_DEFAULT_V_HALF.top
          : _padding.top + _viewInsets.top + HarbrUI.MARGIN_H_DEFAULT_V_HALF.top,
      _padding.right + _viewInsets.right,
      actionBar != null
          ? 0
          : _padding.bottom +
              _viewInsets.bottom +
              HarbrUI.MARGIN_H_DEFAULT_V_HALF.bottom,
    );
  }
}
