...
class HarbrTextInputBar extends StatefulWidget {
  ...
  const HarbrTextInputBar({
    ...
    this.margin = HarbrUI.MARGIN_H_DEFAULT_V_HALF,
    this.focusNode,
...
class _State extends State<HarbrTextInputBar> {
  ...
  InputDecoration get _sharedInputDecoration => InputDecoration(
        labelText: widget.labelText ?? 'harbr.SearchTextBar'.tr(),
