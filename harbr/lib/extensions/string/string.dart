...
extension StringNullableExtension on String? {
  ...
  String uiSafe({
    ...
    if (!isEmptySafe && this!.isEmpty) return HarbrUI.TEXT_EMDASH;
    return this!;
  }
}
...
extension StringExtension on String {
  ...
  Future<void> copyToClipboard({
    ...
    if (showSnackBar) {
      showHarbrSuccessSnackBar(
        title: 'harbr.Copied'.tr(),
        message: 'harbr.CopiedContentToTheClipboard'.tr(),
      );
    }
  }
  ...
  String bulleted({
    String bullet = HarbrUI.TEXT_BULLET,
    int padCount = 1,
  }) {
