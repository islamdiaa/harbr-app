...
extension IntegerAsDurationExtension on int? {
  ...
  String asWordDuration({
    ...
    if (this == null || this! <= 0) return 'harbr.Unknown'.tr();
    ...
    if (hours > 1) {
      return 'harbr.Hours'.tr(args: [hours.toString()]);
    }

    final minutes = seconds ~/ _MINUTE_IN_SECONDS;
    if (minutes > 0) {
      return 'harbr.Minutes'.tr(args: [minutes.toString()]);
    }

    return 'harbr.Seconds'.tr(args: [seconds.toString()]);
  }
