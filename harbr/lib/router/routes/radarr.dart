...
import 'package:harbr/api/radarr/models/movie/movie.dart';
import 'package:harbr/modules.dart';
import 'package:harbr/modules/radarr/core/state.dart';
import 'package:harbr/modules/radarr/routes/add_movie/route.dart';
import 'package:harbr/modules/radarr/routes/add_movie_details/route.dart';
import 'package:harbr/modules/radarr/routes/edit_movie/route.dart';
import 'package:harbr/modules/radarr/routes/history/route.dart';
import 'package:harbr/modules/radarr/routes/manual_import/route.dart';
import 'package:harbr/modules/radarr/routes/manual_import_details/route.dart';
import 'package:harbr/modules/radarr/routes/movie_details/route.dart';
import 'package:harbr/modules/radarr/routes/queue/route.dart';
import 'package:harbr/modules/radarr/routes/radarr/route.dart';
import 'package:harbr/modules/radarr/routes/releases/route.dart';
import 'package:harbr/modules/radarr/routes/system_status/route.dart';
import 'package:harbr/modules/radarr/routes/tags/route.dart';
import 'package:harbr/router/routes.dart';
import 'package:harbr/vendor.dart';

enum RadarrRoutes with HarbrRoutesMixin {
  HOME('/radarr'),
  ADD_MOVIE('add_movie'),
  ...
  @override
  HarbrModule get module => HarbrModule.RADARR;
