...
import 'package:harbr/modules/lidarr/routes/add_details.dart';
import 'package:harbr/modules/lidarr/routes/add_search.dart';
import 'package:harbr/modules/lidarr/routes/details_album.dart';
import 'package:harbr/modules/lidarr/routes/details_artist.dart';
import 'package:harbr/modules/lidarr/routes/edit_artist.dart';
import 'package:harbr/modules/lidarr/routes/lidarr.dart';
import 'package:harbr/modules/lidarr/routes/search_results.dart';
import 'package:harbr/router/routes.dart';
import 'package:harbr/vendor.dart';

enum LidarrRoutes with HarbrRoutesMixin {
  HOME('/lidarr'),
  ...
  @override
  HarbrModule get module => HarbrModule.LIDARR;
