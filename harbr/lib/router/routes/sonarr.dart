...
import 'package:harbr/api/sonarr/models.dart';
import 'package:harbr/modules.dart';
import 'package:harbr/modules/sonarr/core/state.dart';
import 'package:harbr/modules/sonarr/routes/add_series/route.dart';
import 'package:harbr/modules/sonarr/routes/add_series_details/route.dart';
import 'package:harbr/modules/sonarr/routes/edit_series/route.dart';
import 'package:harbr/modules/sonarr/routes/history/route.dart';
import 'package:harbr/modules/sonarr/routes/queue/route.dart';
import 'package:harbr/modules/sonarr/routes/releases/route.dart';
import 'package:harbr/modules/sonarr/routes/season_details/route.dart';
import 'package:harbr/modules/sonarr/routes/series_details/route.dart';
import 'package:harbr/modules/sonarr/routes/sonarr/route.dart';
import 'package:harbr/modules/sonarr/routes/tags/route.dart';
import 'package:harbr/router/routes.dart';
import 'package:harbr/vendor.dart';

enum SonarrRoutes with HarbrRoutesMixin {
  HOME('/sonarr'),
  ...
  @override
  HarbrModule get module => HarbrModule.SONARR;
